...
<?php if (basel_needs_footer()): ?>
	...
	<footer class="rlg-footer-container">
					...
					<details class="rlg-footer-accordion" open>
						...
						<div class="rlg-footer-accordion-content">
							<ul class="rlg-footer-menu">
								...
								<li><a href="<?php echo esc_url(home_url('/affiliate-disclosure')); ?>">Affiliate Program</a></li>
				...
				<div class="rlg-footer-right">
					...
					<div class="rlg-footer-logo">
						<?php if (function_exists('the_custom_logo') && has_custom_logo()): ?>
							<?php the_custom_logo(); ?>
						<?php else: ?>
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo-white.png" alt="Real Leather Garments" />
						<?php endif; ?>
					</div>
					...
					<div class="rlg-footer-meta">
						<div class="rlg-footer-contact">
							...
							<a href="mailto:contact@realleathergarments.co.uk">contact@realleathergarments.co.uk</a>
						</div>

						<div class="rlg-footer-actions">
							<a href="<?php echo esc_url(home_url('/track-order')); ?>" class="rlg-track-order">Track Your Order</a>
		...
		<div class="rlg-footer-bottom">
			<div class="container">
				<p>&copy; <?php echo date('Y'); ?> Real Leather Garments. All rights reserved.</p>
			</div>
		</div>
